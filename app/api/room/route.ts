...
const FALLBACKS: Record<string, string> = {
  intro: "Welcome! 大家好呀！我们先来认识一下吧～\n试试用英文说：My name is... I like... I am in Grade...",
  ...
  warmup: "太棒了！Now let's chat! 你们可以聊聊喜欢什么～",
    ...
    switch (action) {
      case "intro": {
        const msgs = buildHostPrompt(
          body,
          "请用温暖有趣的方式介绍房间，引导两个小朋友用简单英文自我介绍。给出模板：My name is... I like... I am in Grade..."
        );
      ...
      case "warmup": {
        const msgs = buildHostPrompt(
          body,
          `双方都已经介绍完毕了。请热情地鼓励两个小朋友开始聊天，可以给一个有趣的话题引子让他们聊起来，比如问一个轻松好玩的问题。1-2句话，穿插英文。`
        );
        reply = await callDoubao(msgs);
        break;
      }
